...
class PersianDatePickerWidget extends StatefulWidget {
  ...
  void update(
    ...
    options['minSpan'] = minSpan ?? options['minSpan'];
    options['maxSpan'] = maxSpan ?? options['maxSpan'];

    if (minDatetime != null) {
      options['minDatetime'] = minDatetime ?? options['minDatetime'];
    }
    if (maxDatetime != null) {
      options['maxDatetime'] = maxDatetime ?? options['maxDatetime'];
    }
  }
...
dynamic _parseDatetimeInput(datetime, format, separator) {
  try {
  ...
  Widget _datePickerPageHeader(pageInfo) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Expanded(
            flex: widget.options['headerTodayIcon'] != null ? 3 : 1,
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                GestureDetector(
          ...
          widget.options['headerTodayIcon'] != null
              ? Expanded(
                  flex: 1,
                  child: InkWell(
                    onTap: () {
                        ...
                        children: <Widget>[
                          ...
                          Container(
                              ...
                              child: Text(widget.options['headerTodayCaption'],
                                  style:
                                      widget.options['headerTodayTextStyle']))
                        ],
                      ),

...
class SatnaTransferConfirmDialog extends StatefulWidget {
  SatnaTransferConfirmDialog({
    @required this.name,
  ...
  @override
  _SatnaTransferConfirmDialogState createState() =>
      _SatnaTransferConfirmDialogState();
}

class _SatnaTransferConfirmDialogState
    extends State<SatnaTransferConfirmDialog> {
  @override
